...
cl = LINETCR.LINE()
cl.login(token="EudWeaZ1cUHcfbKbJPXe.GavN1Hw3jJdD18KMaWkM7G.uyJ2JmFogQNVf49/ZzYAoSWwWDdk9XiNJxqjkT12doE=")
cl.loginResult()
...
༒➣  Auto leave on/off
༒➣  Auto like on/off
༒➣  เปิดต้อนรับ เปิด/ปิด➣เปิดระบบต้อนรับ
༒➣  Auto notice on/
༒➣  Blockinvite on/off
༒➣  Auto blockqr on/off
༒➣  Namelock on/off
...
targets = []
Bots=[mid]
admin = ["u800567d615b72630ddd7c9260302a6ee"]
owner = ["u800567d615b72630ddd7c9260302a6ee"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#==================================================
              ...
              if msg.from_ in admin:
                    ...
                    try:
                        cl.sendText(msg.to,"รีบูทบอท...✔️")
                        restart_program()
                    except:
                        cl.sendText(msg.to,"รอชักครู่✔️")
                        restart_program()
                        pass
...
#================================================================================
	      ...
	      if msg.from_ in admin:
            ...
            elif 'เปิดลิ้ง' in msg.text.lower():
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    uye.updateGroup(X)
                    if wait["lang"] == "JP":
                         cl.sendText(msg.to,"เปิดQrสำเร็จ✔️")
                    else:
                        uye.sendText(msg.to,"เปิดอยู่แล้ว")
                else:
                    if wait["lang"] == "JP":
                        uye.sendText(msg.to,"ไม่สามารถใช้นอกกลุ่ม✔️")
                    else:
                        uye.sendText(msg.to,"ไม่สามารถใช้งานใด้✔️")
#===========================================================================
         
            elif 'ปิดลิ้ง' in msg.text.lower():
              if msg.from_ in admin:
                if msg.toType == 2:
                    uye = random.choice(KAC)
                    X = cl.getGroup(msg.to)
                    ...
                    uye.updateGroup(X)
                    if wait["lang"] == "JP":
                        uye.sendText(msg.to,"โปรดรอ✔️")
                    else:
                        uye.sendText(msg.to,"ปิดQrสำเร็จ✔️")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ไม่สามารถใช้นอกกลุ่ม✔️")
                    else:
                        uye.sendText(msg.to,"ไม่สามารถใช้งานใด้✔️")
#============================================================
...
#==================================================================
            ...
            elif "แอดมิน on @" in msg.text:
                if msg.from_ in owner:
                    print "[Command]Staff add executing"
                    _name = msg.text.replace("แอดมิน on @","ubf4806077f2b20dd22fb3a7072eb0eb8")
                    ...
                    if targets == []:
                        cl.sendText(msg.to,"ไม่พบที่อยู่ติดต่อ✔️")
                    else:
                        for target in targets:
                            try:
                                admin.append(target)
                                cl.sendText(msg.to,"ความสำเร็จเพิ่มลงในรายชื่อผู้ดูแลระบบ✔️")
                            except:
                                pass
...
#=================================================================
              ...
              if msg.from_ in admin:
                if wait["welcomemsg"] == True:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ข้อความต้อนรับเปิด✔️\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"welcome message on")
              ...
              if msg.from_ in admin:
                if wait["welcomemsg"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ข้อความต้อนรับปิด✔️\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
              ...
              if msg.from_ in admin:
	           ...
	           if msg.from_ in admin:
                    ...
                    try:
                       ...
                       pass
            elif "ก้อป @" in msg.text:
                if msg.toType == 2:
                    if msg.from_ in admin:
                        print "[COPY] Ok"
                        _name = msg.text.replace("ก้อป @","")
                        _nametarget = _name.rstrip('  ')
                        gs = cl.getGroup(msg.to)
                        targets = []
                        for g in gs.members:
